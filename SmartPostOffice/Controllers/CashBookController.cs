...
public class CashBookController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        ViewBag.GrandTotal = summaries.Sum(s => ((dynamic)s).Total);
    ...
    public async Task<IActionResult> DailyReport(DateTime? date = null)
    {
        ...
        ViewBag.GrandCash   = registers.Sum(r => ((dynamic)r).CashTotal);
        ViewBag.GrandOnline = registers.Sum(r => ((dynamic)r).OnlineTotal);
        ViewBag.GrandTotal  = registers.Sum(r => ((dynamic)r).Total);
